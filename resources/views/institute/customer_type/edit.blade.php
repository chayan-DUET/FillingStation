...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Update Customer Type </h2>
    </div>
...
<div class="col-md-12">
    <div class="panel panel-default">
        <div class="panel-heading">Customer Type Information</div>
        <div class="panel-body">
            {!! Form::open(['method' => 'PUT', 'url' => 'customer_type/'.$data->id, 'class' => 'form-horizontal']) !!} 
            {{ csrf_field() }}
