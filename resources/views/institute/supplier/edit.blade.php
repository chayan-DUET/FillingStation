...
<div class="col-md-12">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            {!! Form::open(['method' => 'PUT', 'url' => 'supplier/'.$data->id, 'class' => 'form-horizontal']) !!} 
            {{ csrf_field() }}
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <div class="col-md-6">
                    <select id="InstituteList" class="form-control" name="company_id">
                        <option value="">Select Company</option>                  
                        @foreach($company_set as $il)
                        <?php $sel = ($il->id == $data->company_id) ? 'selected="selected"' : ''; ?>
                        <option value="{{$il->id}}" {{$sel}}>{{$il->company_name }}</option>
                        @endforeach
                    </select>
