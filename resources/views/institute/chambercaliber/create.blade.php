...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Create New Chamber Caliber</h2>
    </div>
...
<div class="col-md-12">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            {!! Form::open(['method' => 'POST', 'url' => 'chambercaliber', 'id' => 'frm_product'  , 'class' => 'form-horizontal']) !!} 
            {{ csrf_field() }}
            @if( is_Admin() )
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <select id="chamber" class="form-control" name="chamber_id" required>
                        @if ( !is_Admin() )
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="number" id="mm" class="form-control" name="mm" required>
                   
                </div>
            </div>
            <div class="form-group">
                <label for="chamber_capacity" class="col-md-4 control-label">Liter</label>
                <div class="col-md-6">
                    <input type="number" id="chamber_capacity" class="form-control" name="liter" required>
