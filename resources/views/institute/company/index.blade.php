        ...
        <tbody>
            <tr>
                ...
                <td class="text-right wmd_30" style="width:20%">
                    <a href="{{ url ('/company/create') }}"><button class="btn btn-success btn-xs"><i class="fa fa-plus"></i> New</button></a>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center hip">
                            <a class="btn btn-info btn-xs" href="company/{{ $data->_key }}/edit"><i class="fa fa-edit"></i> Edit</a>
                        </td>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#search").click(function () {
            var _url = "{{ URL::to('company/search') }}";
            var _form = $("#frmSearch");
        ...
        $("#Del_btn").click(function () {
            var _url = "{{ URL::to('company/delete') }}";
            var _form = $("#frmList");
