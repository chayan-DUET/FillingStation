...
<div class="col-md-12">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            {!! Form::open(['method' => 'POST', 'url' => 'category', 'id' => 'frm_head'  , 'class' => 'form-horizontal']) !!} 
            {{ csrf_field() }}
            @if( is_Admin() )
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 input_fields_wrap">
                    <div><input type="text" class="form-control" name="category_name[]" required></div>
    ...
    $(document).ready(function () {
        ...
        $(add_button).click(function (e) { //on add input button click
            ...
            if (x < max_fields) { //max input box allowed
                ...
                $(wrapper).append('<div class="text-center"><input type="text" class="duplicate_field" name="category_name[]" required/>&nbsp;<a href="#" class="remove_field btn btn-danger btn-sm">Remove </a></div>'); //add input box
            }
        });
