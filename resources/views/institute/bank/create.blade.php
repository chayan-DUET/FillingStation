...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Create New Bank</h2>
    </div>
...
<div class="col-md-12">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            {!! Form::open(['method' => 'POST', 'url' => 'bank', 'id' => 'frm_head'  , 'class' => 'form-horizontal']) !!} 
            {{ csrf_field() }}
            @if( is_Admin() )
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 input_fields_wrap">
                    <div><input type="text" class="form-control" name="bank_name[]" required></div>
    ...
    $(document).ready(function () {
        ...
        $(add_button).click(function (e) { //on add input button click
            ...
            if (x < max_fields) { //max input box allowed
                ...
                $(wrapper).append('<div class="text-center"><input type="text" class="duplicate_field" name="bank_name[]" required/>&nbsp;<a href="#" class="remove_field btn btn-danger btn-sm">Remove </a></div>'); //add input box
            }
        });
