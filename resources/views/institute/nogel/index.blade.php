...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Nogel List</h2>
    </div>
    <div class="col-md-3 col-sm-3 col-xs-4 cxs_12 no_pad">
        <ul class="text-right no_mrgn">
            <li><a href="{{ url('/home') }}"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a> <span class="divider">/</span></li><li><span><i class="fa fa-file"></i> Nogel</span></li>
        </ul>                            
    </div>
</div>
<div class="well">
        ...
        <tbody>
            <tr>
                ...
                <td class="text-right wmd_30" style="width:20%">
                    <a href="{{ url ('/nogel/create') }}"><button class="btn btn-success btn-xs"><i class="fa fa-plus"></i> New</button></a>
            ...
            <table class="table table-bordered tbl_thin" id="check">
                <tbody>
                    <tr class="bg_gray" id="r_checkAll">
                        ...
                        <th class="{{ show_hide() }} text-center">Deep Name</th>
                        <th class="{{ show_hide() }} text-center">Station Name</th>
                        <th class="text-center">Nogel No</th>
                    ...
                    <tr>
                        ...
                        <td class="{{ show_hide() }} ">{{ $data->deep->deep_name }}</td>
                        <td class="{{ show_hide() }} ">{{ $data->station->station_name }}</td>
                        <td>{{ $data->nozel_no }}</td>
                        <td class="text-center hip">
                            <a class="btn btn-info btn-xs" href="nogel/{{ $data->_key }}/edit"><i class="fa fa-edit"></i> Edit</a>
                        </td>
