...
<div class="col-md-12">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            {!! Form::open(['method' => 'POST', 'url' => 'product', 'id' => 'frm_product'  , 'class' => 'form-horizontal']) !!} 
            {{ csrf_field() }}
            ...
            <div class="form-group">
                <table class="table table-bordered" style="width: 80%; margin: 0px auto;">
                    ...
                    <tr>
                        <td> <input type="text" placeholder="Product Name" class="form-control" name="product_name[]" required></td>
                        <td> <select id="language" name="unit_name[]" class="form-control">
    ...
    $(document).ready(function () {
        ...
        $(add_button).click(function (e) { //on add input button click
            ...
            if (x < max_fields) { //max input box allowed
                ...
                $(wrapper).append('<tr><td><input type="text" placeholder="Product Name" class="form-control" name="product_name[]" required></td><td> <select id="language" name="unit_name[]" class="form-control"><option value="">Select Unit</option><option value="Liter">Liter</option><option value="piece">piece</option></select></td><td><a href="#" class="remove_field btn btn-danger btn-sm">Remove</a></td></tr>'); //add input box
            }
        });
