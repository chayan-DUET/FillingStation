...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Update Bank Branch </h2>
    </div>
...
<div class="col-md-12">
    <div class="panel panel-default">
        <div class="panel-heading">Bank Branch Information</div>
        <div class="panel-body">
            {!! Form::open(['method' => 'PUT', 'url' => 'bankbranch/'.$data->id, 'class' => 'form-horizontal']) !!} 
            {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <select id="bank" class="form-control" name="bank_id">
                        ...
                        @foreach($bank_set as $bs)
                        <?php $sel = ($bs->id == $data->bank_id) ? 'selected="selected"' : ''; ?>
                        <option value="{{$bs->id}}" {{$sel}}>{{$bs->bank_name }}</option>
                        @endforeach
                    </select>
