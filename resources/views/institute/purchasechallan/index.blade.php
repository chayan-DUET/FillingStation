...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Purchase Challan List</h2>
    </div>
    <div class="col-md-3 col-sm-3 col-xs-4 cxs_12 no_pad">
        <ul class="text-right no_mrgn">
            <li><a href="{{ url('/home') }}"><i class="fa fa-fw fa-dashboard"></i>Dashboard</a> <span class="divider">/</span></li><li><span><i class="fa fa-file"></i>Purchase Challan</span></li>
        </ul>                            
    </div>
</div>
<div class="well">
        ...
        <tbody>
            <tr>
                ...
                <td class="text-right wmd_30" style="width:20%">
                    <a href="{{ url ('/purchasechallan/create') }}"><button class="btn btn-success btn-xs"><i class="fa fa-plus"></i> New</button></a>
            ...
            <table class="table table-bordered tbl_thin" id="check">
                <tbody>
                    <tr class="bg_gray" id="r_checkAll">
                        ...
                        <th class="text-center">Per Amount</th>
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{ $data->institute->name }}</td>
                        <td class="text-center">{{ $data->company->company_name }}</td>
                        <td class="text-center">{{ $data->pay_order_no }}</td>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#search").click(function () {
            var _url = "{{ URL::to('purchasechallan/search') }}";
            var _form = $("#frmSearch");
        ...
        $("#Del_btn").click(function () {
            var _url = "{{ URL::to('purchasechallan/delete') }}";
            var _form = $("#frmList");
