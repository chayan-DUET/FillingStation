...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Create Deep caliber Chart</h2>
    </div>
    <div class="col-md-3 col-sm-3 col-xs-4 cxs_12 no_pad">
        <ul class="text-right no_mrgn">
            <li><a href="{{ url('/home') }}"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a> <span class="divider">/</span></li><li><span><i class="fa fa-file"></i> Deep caliber</span></li>
        </ul>                            
    </div>
</div>
...
<div class="col-md-12">
    <div class="panel panel-default">
        <div class="panel-heading">Deep caliber Information</div>
        <div class="panel-body">
            {!! Form::open(['method' => 'POST', 'url' => 'deepcaliber', 'id' => 'frm_product'  , 'class' => 'form-horizontal']) !!} 
            {{ csrf_field() }}
            ...
            @endif
            <label for="deep" class="col-md-2 control-label">Deep Name</label>
                <div class="col-md-4">
            ...
            <div class="form-group">
                <table class="table table-bordered" style="width: 80%; margin: 0px auto;">
                    ...
                    <tr>
                        <td><input type="number" placeholder="MM" class="form-control" name="mm[]" required></td>
                        <td> <input type="number" placeholder="Liter" class="form-control" name="liter[]" required></td>
                        <td><button class="btn btn-danger btn-sm">remove <i class="fa fa-min" aria-hidden="true"></i></button></td>
                    </tr>
                    </tbody>
                </table>
            </div>
    ...
    $(document).ready(function () {
        ...
        $(add_button).click(function (e) { //on add input button click
            ...
            if (x < max_fields) { //max input box allowed
                ...
                $(wrapper).append('<tr><td><input type="number" placeholder="MM" class="form-control" name="mm[]" required></td><td> <input type="number" placeholder="Liter" class="form-control" name="liter[]" required></td><td><a href="#" class="remove_field btn btn-danger btn-sm">Remove</a></td></tr>'); //add input box
            }
        });
