...
<div class="col-md-12">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            {!! Form::open(['method' => 'PUT', 'url' => 'product/'.$data->id, 'class' => 'form-horizontal']) !!} 
            {{ csrf_field() }}
            <div class="form-group">
                <label for="name" class="col-md-4 control-label">Category Name</label>
                <div class="col-md-6">
                    <select id="ledger_head_id" class="form-control" name="category_id">
                        <option value="">Select Category</option>                  
                        @foreach($category_set as $cs)
                        <?php $sel = ($cs->id == $data->category_id) ? 'selected="selected"' : ''; ?>
