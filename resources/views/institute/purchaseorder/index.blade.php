            ...
            <table class="table table-bordered tbl_thin" id="check">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="{{ show_hide() }} text-center">{{ $data->company->company_name }}</td>
                        <td class="{{ show_hide() }} text-center">{{ $data->supplier->supplier_name }}</td>
                        <td class="text-center">{{ $data->order_no }}</td>
                        <td class="text-center">@if($data->pay_type== 1) Cash
                            @elseif($data->pay_type== 2) Bank
                            @elseDue
                        @endif</td>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#search").click(function () {
            var _url = "{{ URL::to('purchaseorder/search') }}";
            var _form = $("#frmSearch");
        ...
        $("#Del_btn").click(function () {
            var _url = "{{ URL::to('purchaseorder/delete') }}";
            var _form = $("#frmList");
