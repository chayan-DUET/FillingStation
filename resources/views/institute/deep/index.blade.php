...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Deep List</h2>
    </div>
        ...
        <tbody>
            <tr>
                ...
                <td class="text-right wmd_30" style="width:20%">
                    <a href="{{ url ('/deep/create') }}"><button class="btn btn-success btn-xs"><i class="fa fa-plus"></i> New</button></a>
            ...
            <table class="table table-bordered tbl_thin" id="check">
                <tbody>
                    <tr class="bg_gray" id="r_checkAll">
                        ...
                        <th class="{{ show_hide() }} text-center">Comapany Name</th>
                    ...
                    <tr>
                        ...
                        <td>{{ $data->deep_name }}</td>
                        <td class="text-center hip">
                            <a class="btn btn-info btn-xs" href="deep/{{ $data->_key }}/edit"><i class="fa fa-edit"></i> Edit</a> <a class="btn btn-success btn-xs" href="deep/{{ $data->_key }}/edit"><i class="fa fa-edit"></i> view</a>
                        </td>
