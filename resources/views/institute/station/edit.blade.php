...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 cxs_10 text-center">
        <h2 class="page-title">Update Station </h2>
    </div>
...
<div class="col-md-12">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            {!! Form::open(['method' => 'PUT', 'url' => 'station/'.$data->id, 'class' => 'form-horizontal']) !!} 
            {{ csrf_field() }}
            ...
            <div class="form-group">
                <label for="company" class="col-md-4 control-label">Deep Name</label>
                <div class="col-md-6">
                    <select id="company" class="form-control" name="institute_id">
                        <option value="">Select Deep</option>                  
                        @foreach($deep_set as $cs)
                        <?php $sel = ($cs->id == $data->deep_id) ? 'selected="selected"' : ''; ?>
                        <option value="{{$cs->id}}" {{$sel}}>{{$cs->deep_name }}</option>
                        @endforeach
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" name="station_name" value="{{$data->station_name}}">
                    <small class="text-danger">{{ $errors->first('station_name') }}</small>
                </div>
            </div>
            <div class="form-group">
