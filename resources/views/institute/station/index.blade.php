...
<div id="breadcrumbBar" class="breadcrumb site_nav_links no_bdr_rad clearfix">
    ...
    <div class="col-md-3 col-sm-3 col-xs-4 cxs_12 no_pad">
        <ul class="text-right no_mrgn">
            <li><a href="{{ url('/home') }}"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a> <span class="divider">/</span></li><li><span><i class="fa fa-file"></i> Station</span></li>
        </ul>                            
    </div>
</div>
<div class="well">
        ...
        <tbody>
            <tr>
                ...
                <td class="text-right wmd_30" style="width:20%">
                    <a href="{{ url ('/station/create') }}"><button class="btn btn-success btn-xs"><i class="fa fa-plus"></i> New</button></a>
            ...
            <table class="table table-bordered tbl_thin" id="check">
                <tbody>
                    <tr class="bg_gray" id="r_checkAll">
                        ...
                        <th class="{{ show_hide() }} text-center">Product Name</th>
                    ...
                    <tr>
                        ...
                        <td class="text-center hip">
                            <a class="btn btn-info btn-xs" href="station/{{ $data->_key }}/edit"><i class="fa fa-edit"></i> Edit</a>
                        </td>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#search").click(function () {
            var _url = "{{ URL::to('station/search') }}";
            var _form = $("#frmSearch");
        ...
        $("#Del_btn").click(function () {
            var _url = "{{ URL::to('station/delete') }}";
            var _form = $("#frmList");
